...
// Tech/Testing Icons for Background Animation
const BugIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="1.5">
        ...
        <path d="M12 3v18M20 12H4M17.5 17.5 12 12M6.5 6.5 12 12M17.5 6.5 12 12M6.5 17.5 12 12" />
    </svg>
);

const CodeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="1.5">
        <path d="m8 9-5 3 5 3M16 9l5 3-5 3M14 4l-4 16" />
    </svg>
);
...
const ApiIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="1.5">
        <path d="M10 20H4v-6M14 4h6v6M14 10v10h10" />
    </svg>
);

const ShieldIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="1.5">
        <path d="M12 22S3 18 3 6V3h18v3c0 12-9 16-9 16Z" />
    </svg>
);
...
export const TechIcons = [BugIcon, CodeIcon, SearchIcon, ApiIcon, ShieldIcon, DatabaseIcon];